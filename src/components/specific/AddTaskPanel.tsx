...
export default function AddTaskPanel({projectId,showPanel,setShowPanel,editingTask,setEditingTask}: AddTaskPanelProps) {
...
>
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <h2 className="text-lg font-semibold">{editingTask? 'Update Task':'Create New Task'}</h2>
